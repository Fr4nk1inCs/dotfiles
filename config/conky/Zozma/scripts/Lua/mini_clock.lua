...
To call this conky, Add this command before "TEXT" in conkyrc file:
   ...
   lua_load ~/.config/conky/Conky-Name/scripts/lua/min_clock.lua
...
local clock_table = {
    ...
    -- Main settings
    xc = scale * 155, -- centre of the clock
    yc = scale * 155,
    R = scale * 140, -- default radius of the clock
    RH = scale * 100, -- outher radius for hours fill ring
    RM = scale * 120, -- outer radius for minutes fill ring
    rh = scale * 7, -- hour ring fill raius
    rm = scale * 7, -- minutes ring fill radius
    rs = scale * 7, -- seconds ring fill radius
    ...
    fill_colorS = { 0x81A1C1, 1 }, -- fill color for seconds ring
